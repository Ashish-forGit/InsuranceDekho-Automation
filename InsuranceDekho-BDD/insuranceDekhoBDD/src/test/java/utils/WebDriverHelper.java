...
public class WebDriverHelper {
	...
	/**
	 * Description: Selects a dropdown option by visible text.
	 *
	 * @param droplocator Locator for dropdown element
	 * @param value       Visible text value to select
	 * @author Ashish Kumar
	 */
	public void selectDropDownValue(By droplocator, String value) {
		WebElement element = driver.findElement(droplocator);
		Select select = new Select(element);
		select.selectByVisibleText(value);
	}

	/**
	 * Description: Scrolls the page to bring the given element into view using
	 * JavaScript, and adjusts scroll position slightly upwards.
	 *
	 * @param locator Locator for the element to scroll into view
	 * @author Ashish Kumar
	 */
	...
	/**
	 * Description: Selects dropdown option by visible text after waiting for
	 * element visibility.
	 *
	 * @param locator Locator of dropdown element
	 * @param value   Visible text to select
	 * @author Ashish Kumar
	 */
	...
	/**
	 * Description: Returns list of WebElements found using the given XPath.
	 *
	 * @param blacklist XPath expression
	 * @return List of matching WebElements
	 * @author Ashish Kumar
	 */
	public List<WebElement> getElementsByXPath(String blacklist) {
		return driver.findElements(By.xpath(blacklist));
	}

	/**
	 * Description: Switches to iframe using the iframe locator by reading its
	 * 'name' attribute.
	 *
	 * @param frameLocator Locator of iframe element
	 * @author Ashish Kumar
	 */
	public void switchToIFrame(By frameLocator) {
		String str = driver.findElement(frameLocator).getAttribute("name");
	...
	/**
	 * Description: Switches WebDriver focus from parent window to the newly opened
	 * child window.
	 *
	 * @author Ashish Kumar
	 */
	...
	/**
	 * Description: Checks whether an element is visible on the page.
	 *
	 * @param locator Element locator
	...
	/**
	 * Description: Asserts that the element is visible on the page.
	 *
	 * @param locator        Element locator
	 * @param failureMessage Message shown if assertion fails
	 * @author Ashish Kumar
	 */
	public void assertElementVisible(By locator, String failureMessage) {
		Assert.assertTrue( failureMessage,isElementVisible(locator));
	}
