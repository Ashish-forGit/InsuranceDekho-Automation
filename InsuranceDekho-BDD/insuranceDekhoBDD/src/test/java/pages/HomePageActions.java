...
public class HomePageActions {
	 ...
	 *
	 * @Test_Case NV_US01_TC01 - , NV_US01_TC02 - , NV_US01_TC03 -
	 * 
	 * @author Ashish Kumar
	 */
	 ...
	 *
	 * @Test_Case NV_US01_TC01 - verifyHomePageLogoVisibility
	 * @author Ashish Kumar
	 */
	...
	public void hoverOverInvestmentMenu() {
		try {
			...
			helper.addLogAndReportInfo("Failed to hover over Investment Menu: ", test);
	...
	public void clickOnInvestmentPlans() {
		try {
			...
			helper.addLogAndReportInfo("Exception in clickOnInvestmentPlans", test);
	...
	public void hoverOverInsuranceAdvisors() {
		try {
			...
			helper.addLogAndReportInfo("Exception in hoverOverInsuranceAdvisors", test);
	 ...
	 *
	 * @Test_Case NV_US12_TC01 - verifyRenewPolicyOtpValidation
	 * @author Ashish Kumar
	 */
	public void typeMobile() {
		try {
			String value = "9876546111";
	 ...
	 *
	 *
	 * verifyHealthInsuranceNewsNavigation
	 * 
	 * @author Ashish Kumar
	 */
